    ...
    <div class="container py-5">
        <div class="row justify-content-center">
            ...
            <div class="col-md-6 mb-4">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 text-center text-md-start">
                        <h5 class="text-primary fw-bold">Soofi Autos (Mr, Mati Ullah & Mr, Mudassir)</h5>
                        <ul class="list-unstyled">
                            <li><i class="fas fa-map-marker-alt text-primary me-2"></i> 19 - Jan Plaza, Peshawar Cantt
                            </li>
                    ...
                    <div class="col-md-6 text-center text-md-start">
                        <h5 class="text-primary fw-bold">Ubaid Motors (Mr. Shoaib)</h5>
                        <ul class="list-unstyled">
                            <li><i class="fas fa-map-marker-alt text-primary me-2"></i> Cantt plaza, Fakhar e Alam road, Peshawar, Kpk, Pakistan</li>
                            ...
                            <li><i class="fa-brands fa-whatsapp text-primary fs-5 me-2"></i> +92-300-5961283 (Shoaib)
                            </li>
                        </ul>
                    </div>
                </div>
            ...
            <div class="col-md-3 text-center text-md-start mb-4">
                ...
                <ul class="list-unstyled">
                    <li><i class="fas fa-map-marker-alt text-primary me-2"></i> Shop#6, Fal Hotel Building, Baniyas
                        Metro Station, Deira Dubai, UAE</li>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 text-md-start mb-2 mb-md-0">
                    &copy; 2023 <span class="text-primary fw-bold">{{ config('app.name') }}</span>, All rights reserved.
                    Powered by <span class="text-primary fw-bold">WebWaveSolutions</span>
                </div>
