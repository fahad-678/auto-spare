        ...
        <div class="row mb-10 d-flex justify-content-center">
            ...
            <div class="col-md-2">
                <div class="position-relative">
                    <input type="text" id="searchInput" name="product_search" class="form-control" placeholder="Search products..." value="{{ request('product_search') }}">
                    <div id="autocompleteResults" class="position-absolute w-100 bg-white border rounded-bottom" style="display:none; z-index: 1000;"></div>
                </div>
            </div>
            <div class="col-md-1">
