<div>
    <div class="mt-10 position-relative">
        <div id="carouselExampleSlidesOnly" class="carousel slide hero-section" data-bs-ride="carousel">
            <div class="position-absolute new-arrival-text">
            ...
            <div class="carousel-inner">
              <div class="carousel-item active" data-bs-interval="3000">
                <img src="{{asset('assets/media/stock/1600x800/img-2.jpg')}}" class="d-block w-100" alt="....">
              </div>
        ...
        <div class="position-relative bg-white shadow-lg py-2" style="bottom: 75px">
            <div class="row my-5">
                <div class="col-3 text-center">
                    <p class="fs-3x fw-bolder mb-0 ">2,500 <span class="text-primary">+</span></p>
                    <p class="fs-4">Brand Product</p>
                </div>
                <div class="col-3 text-center">
                    <p class="fs-3x fw-bolder mb-0 ">96 <span class="text-primary">%</span></p>
                    <p class="fs-4">Customer Satisfaction</p>
                </div>
                <div class="col-3 text-center">
                    <p class="fs-3x fw-bolder mb-0 ">120 <span class="text-primary">+</span></p>
                    <p class="fs-4">Offline Store</p>
                </div>
                <div class="col-3 text-center">
                    <p class="fs-3x fw-bolder mb-0 ">75 <span class="text-primary">+</span></p>
                    <p class="fs-4">Professional Team</p>
                </div>
            </div>
        </div>
    </div>
    <div class="text-center container">
        <p class="fs-2qx fw-bolder">New Arrivals Parts</p>
        @for ($i = 1; $i < 5; $i++)
        <div class="row mb-3">
            @for ($j = 0; $j < 4; $j++)
            <div class="col-3">
