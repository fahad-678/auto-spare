        ...
        <div class="col-5 animate" data-animate="left">
            <div class="card text-bg-dark">
                ...
                <div class="card-img-overlay d-flex flex-column align-items-end justify-content-center">
                  ...
                  <button class="card-text btn btn-primary btn-sm animate" data-animate="bounce">Discover More</button>
                </div>
              </div>
        </div>
                ...
                <div class="row card-img-overlay p-0 align-items-center">
                    ...
                    <div class="col-9">
                        <div class="row">
                            ...
                            <div class="col-3 animate" data-delay="0.2s">
                                <div class="card border-0 text-center position-relative">
                            ...
                            <div class="col-3 animate" data-delay="0.3s">
                                <div class="card border-0 text-center position-relative">
                            ...
                            <div class="col-3 animate pe-6" data-delay="0.4s">
                                <div class="card border-0 text-center position-relative">
