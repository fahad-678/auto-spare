...
<div class="container py-10">
    <div class="card mb-3" >
        <div class="row g-0">
          ...
          <div class="col ps-6 d-flex align-items-center">
            <div class="card-body py-0">
                ...
                <div class="row animate">
                    <div class="col-12">
                        <div class="card border-0 shadow-none mb-3" >
                            <div class="row g-0">
                              <div class="col-md-2">
                                <img src="{{asset('assets/media/promotion/image1.jpg')}}" class="img-fluid" alt="...">
                              </div>
                ...
                <div class="row animate mb-8" data-delay="0.2s">
                    <div class="col-12">
                        <div class="card border-0 shadow-none" >
                            <div class="row g-0">
                              <div class="col-md-2">
                                <img src="{{asset('assets/media/promotion/image2.jpg')}}" class="img-fluid" alt="...">
                              </div>
                              <div class="col ps-4 d-flex align-items-center">
                                <div class="card-body p-1 pt-5">
        ...
        @foreach (array_chunk($brands, 5) as $rowIndex => $brandRow)
            <div class="row g-0 px-8 justify-content-center">
              ...
              <div class="col-2 text-center animate" data-animate="left">
                  ...
                  @endphp
                  <p class="fs-2 p-4 m-0 {{ $class }}" data-animate="{{ $rowIndex == 0 ? 'left' : 'bottom' }}">
                    <img src="{{ asset('assets/media/brands-we-deal-in/' . $brand[0] . '.png') }}" width="150" alt="{{ $brand[0] }}" class="img-fluid">
                  </p>
              </div>
              @endforeach
          </div>
