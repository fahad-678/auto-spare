...
<div class="container mt-md-20 mt-10">
    <!--begin::Form-->
    <form class="form w-100" novalidate="novalidate" id="kt_sign_in_form" data-kt-redirect-url="{{ route('products.index') }}" action="{{ route('login') }}">
        @csrf
        <!--begin::Heading-->
        ...
        <!--end::Separator-->
            <div class="card mb-3">
                <div class="row g-0 align-items-center">
                  <div class="col-md-6">
                    <div class="card-body">
                        <h1 class="text-gray-900 fw-bolder mb-6 text-center">
                            Sign In
                        </h1>
                  ...
                  <div class="col-md-6">
                    <img src="{{asset('assets/media/stock/900x600/11.jpg')}}" class="img-fluid rounded" alt="...">
                  </div>
                </div>
              </div>
        <!--begin::Input group--->
